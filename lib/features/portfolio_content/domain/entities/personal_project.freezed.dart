...
mixin _$PersonalProject {
 ...
 MediaRef get cover;/// Composed showcase panels shown in the detail view — feature graphic,
/// screenshots and GIFs. Video lives in [videos] instead: see
/// [ProjectVideo] for why it isn't a panel.
 List<ShowcasePanel> get panels;/// The project's videos — screen recordings and YouTube walkthroughs.
 List<ProjectVideo> get videos;/// Default background for this project's panels and videos. Five
...
@useResult
$Res call({
 String id, String title, String titleAr, String description, String descriptionAr, List<String> features, List<String> featuresAr, String category, String categoryAr, MediaRef cover, List<ShowcasePanel> panels, List<ProjectVideo> videos, ShotBackground showcaseBackground, List<ProjectLink> links, List<String> skills, List<String> skillsAr, List<String> technologies, List<String> tools, String accentHex, int order
});
...
as List<ShowcasePanel>,videos: null == videos ? _self.videos : videos // ignore: cast_nullable_to_non_nullable
as List<ProjectVideo>,showcaseBackground: null == showcaseBackground ? _self.showcaseBackground : showcaseBackground // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String titleAr,  String description,  String descriptionAr,  List<String> features,  List<String> featuresAr,  String category,  String categoryAr,  MediaRef cover,  List<ShowcasePanel> panels,  List<ProjectVideo> videos,  ShotBackground showcaseBackground,  List<ProjectLink> links,  List<String> skills,  List<String> skillsAr,  List<String> technologies,  List<String> tools,  String accentHex,  int order)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PersonalProject() when $default != null:
return $default(_that.id,_that.title,_that.titleAr,_that.description,_that.descriptionAr,_that.features,_that.featuresAr,_that.category,_that.categoryAr,_that.cover,_that.panels,_that.videos,_that.showcaseBackground,_that.links,_that.skills,_that.skillsAr,_that.technologies,_that.tools,_that.accentHex,_that.order);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String titleAr,  String description,  String descriptionAr,  List<String> features,  List<String> featuresAr,  String category,  String categoryAr,  MediaRef cover,  List<ShowcasePanel> panels,  List<ProjectVideo> videos,  ShotBackground showcaseBackground,  List<ProjectLink> links,  List<String> skills,  List<String> skillsAr,  List<String> technologies,  List<String> tools,  String accentHex,  int order)  $default,) {final _that = this;
switch (_that) {
case _PersonalProject():
return $default(_that.id,_that.title,_that.titleAr,_that.description,_that.descriptionAr,_that.features,_that.featuresAr,_that.category,_that.categoryAr,_that.cover,_that.panels,_that.videos,_that.showcaseBackground,_that.links,_that.skills,_that.skillsAr,_that.technologies,_that.tools,_that.accentHex,_that.order);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String titleAr,  String description,  String descriptionAr,  List<String> features,  List<String> featuresAr,  String category,  String categoryAr,  MediaRef cover,  List<ShowcasePanel> panels,  List<ProjectVideo> videos,  ShotBackground showcaseBackground,  List<ProjectLink> links,  List<String> skills,  List<String> skillsAr,  List<String> technologies,  List<String> tools,  String accentHex,  int order)?  $default,) {final _that = this;
switch (_that) {
case _PersonalProject() when $default != null:
return $default(_that.id,_that.title,_that.titleAr,_that.description,_that.descriptionAr,_that.features,_that.featuresAr,_that.category,_that.categoryAr,_that.cover,_that.panels,_that.videos,_that.showcaseBackground,_that.links,_that.skills,_that.skillsAr,_that.technologies,_that.tools,_that.accentHex,_that.order);case _:
  return null;
...
class _PersonalProject extends PersonalProject {
  const _PersonalProject({required this.id, required this.title, this.titleAr = '', this.description = '', this.descriptionAr = '', final  List<String> features = const <String>[], final  List<String> featuresAr = const <String>[], this.category = '', this.categoryAr = '', this.cover = const MediaRef(), final  List<ShowcasePanel> panels = const <ShowcasePanel>[], final  List<ProjectVideo> videos = const <ProjectVideo>[], this.showcaseBackground = const ShotBackground(), final  List<ProjectLink> links = const <ProjectLink>[], final  List<String> skills = const <String>[], final  List<String> skillsAr = const <String>[], final  List<String> technologies = const <String>[], final  List<String> tools = const <String>[], this.accentHex = '4CC9F0', this.order = 0}): _features = features,_featuresAr = featuresAr,_panels = panels,_videos = videos,_links = links,_skills = skills,_skillsAr = skillsAr,_technologies = technologies,_tools = tools,super._();
...
/// The project's videos — screen recordings and YouTube walkthroughs.
 final  List<ProjectVideo> _videos;
/// The project's videos — screen recordings and YouTube walkthroughs.
@override@JsonKey() List<ProjectVideo> get videos {
...
as List<ShowcasePanel>,videos: null == videos ? _self._videos : videos // ignore: cast_nullable_to_non_nullable
as List<ProjectVideo>,showcaseBackground: null == showcaseBackground ? _self.showcaseBackground : showcaseBackground // ignore: cast_nullable_to_non_nullable
